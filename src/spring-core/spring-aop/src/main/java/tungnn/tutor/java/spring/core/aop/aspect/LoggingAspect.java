package tungnn.tutor.java.spring.core.aop.aspect;
...
public class LoggingAspect {
  ...
  @Before("execution(* tungnn.tutor.java.spring.core.aop.service.BeanService.*(..))")
  ...
  @AfterReturning(
      pointcut = "execution(* tungnn.tutor.java.spring.core.aop.service.BeanService.*(..))",
      returning = "result")
  ...
  @After("execution(* tungnn.tutor.java.spring.core.aop.service.BeanService.*(..))")
